    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.all_products.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-border table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.all_products.inputs.image')
                            </th>
                            <th class="text-left">
                                @lang('crud.all_products.inputs.name')
                            </th>
                            <th class="text-left">
                                @lang('crud.all_products.inputs.subcategory_id')
                            </th>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('all-products.show', $products) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">{!! $allProducts->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
